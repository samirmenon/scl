...
#define SCL_TASKCUSTOM_SPATIAL_RESOLUTION 0.005
#define SCL_TASKCUSTOM_DOF 3

  STaskCustom::STaskCustom() : STaskBase(),
      link_name_(""),
      link_ds_(S_NULL),
      spatial_resolution_(SCL_TASKCUSTOM_SPATIAL_RESOLUTION),
      rbd_(S_NULL),
      enable_wonky_behavior_(false)
  { }

  STaskCustom::~STaskCustom()
  { }


  bool STaskCustom::initTaskParams()
  {
    try
    {
