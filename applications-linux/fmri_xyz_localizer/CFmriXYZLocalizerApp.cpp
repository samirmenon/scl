...
namespace scl_app
{
  ...
  CFmriXYZLocalizerApp::CFmriXYZLocalizerApp() :
      ctrl_(S_NULL),
      name_com_task_(""),
      task_com_(S_NULL),
      task_ds_com_(S_NULL),
  ...
  scl::sBool CFmriXYZLocalizerApp::initMyController(const std::vector<std::string>& argv,
      scl::sUInt args_parsed)
  {
    ...
    { std::cout<<"\nCFmriXYZLocalizerApp::initMyController() : "<<e.what(); }
    return false;
  }

  scl::sBool CFmriXYZLocalizerApp::registerCustomDynamicTypes()
  { return true;  }//No custom tasks to register

  void CFmriXYZLocalizerApp::setInitialStateForUIAndDynamics()
  {
  ...
  void CFmriXYZLocalizerApp::stepMySimulation()
  {
