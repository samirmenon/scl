...
#ifndef CTASKOPEXAMPLE_HPP_
#define CTASKOPEXAMPLE_HPP_
...
namespace scl_app
{
   ...
   */
  class CTaskOpExample : public scl::CTaskBase
  {
  public:
    /********************************
     * CTaskBase API
    ...
    /* *******************************
     * CTaskOpExample specific functions
     ******************************** */
