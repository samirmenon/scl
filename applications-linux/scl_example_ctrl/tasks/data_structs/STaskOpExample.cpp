...
#define SCL_TASKOPEXAMPLE_SPATIAL_RESOLUTION 0.005
#define SCL_TASKOPEXAMPLE_DOF 3

  STaskOpExample::STaskOpExample() : STaskBase(),
      link_name_(""),
      link_ds_(S_NULL),
  ...
  bool STaskOpExample::initTaskParams()
  {
    try
    {
      ...
      link_ds_ = dynamic_cast<const scl::SRigidBody *>(robot_->robot_br_rep_.at_const(link_name_));
      if(S_NULL == link_ds_)
