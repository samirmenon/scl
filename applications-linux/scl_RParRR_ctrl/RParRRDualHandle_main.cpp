 ...
 */
/* \file RParRRDualHandle_main.cpp
 *
...
class SHiredisStructRParRRDualHandle{
public:
...
/**
 * A sample application to compute the dynamics of an RParRRDualHandle robot
 *
...
{
  bool flag;
  std::cout<<"\nThe scl-RParRRDualHandle application demonstrates how to compute dynamics for a closed chain ."
      <<"\nNote that this application will use the RParRRDualHandle as an example.\n";
  try
  {
    /******************************Initialization************************************/
    ...
    const std::string fname("../../specs/RParRRDual/RParRRDualHandleCfg.xml"), robot_name("RParRRDualHandleBot");
    ...
    flag = p.readGraphicsFromFile(fname,"RParRRDualHandleBotStdView",rgr);
    ...
    flag = flag && rchai.addSphereToRender("RParRRDualHandleBot", "link4", Eigen::Vector3d(1.5,0,0), 0.0275, &rtask_lhand_gr);
    ...
    flag = flag && rchai.addSphereToRender("RParRRDualHandleBot", "link9", Eigen::Vector3d(1.5,0,0), 0.0275, &rtask_rhand_gr);
    ...
    //  q_unconstrained_robot = C * q_RParRRDualHandle
    // dq_unconstrained_robot = C * dq_RParRRDualHandle
    Eigen::MatrixXd CRParRRDualHandle;
    CRParRRDualHandle.setZero(12,6);
    CRParRRDualHandle(0,0) = 1;
    CRParRRDualHandle(1,1) = 1;
    CRParRRDualHandle(2,2) = 1;
    CRParRRDualHandle(3,1) = 1;
    CRParRRDualHandle(3,2) = -1;
    CRParRRDualHandle(4,1) = -1;
    CRParRRDualHandle(4,2) = 1;

    CRParRRDualHandle(5,3) = 1;
    CRParRRDualHandle(6,4) = 1;
    CRParRRDualHandle(7,5) = 1;
    CRParRRDualHandle(8,4) = 1;
    CRParRRDualHandle(8,5) = -1;
    CRParRRDualHandle(9,4) = -1;
    CRParRRDualHandle(9,5) = 1;
    ...
    //  q_unconstrained_robot = CSim * q_RParRRDualHandle_sim
    // dq_unconstrained_robot = CSim * dq_RParRRDualHandle_sim
    Eigen::MatrixXd CSimRParRRDualHandle;
    CSimRParRRDualHandle.setZero(12,12);
    CSimRParRRDualHandle(0,0) = 1;
    CSimRParRRDualHandle(1,1) = 1;
    CSimRParRRDualHandle(2,1) = 1;
    CSimRParRRDualHandle(2,4) = 1;
    CSimRParRRDualHandle(3,1) = 1;
    CSimRParRRDualHandle(3,2) = -1;
    CSimRParRRDualHandle(4,4) = 1;

    CSimRParRRDualHandle(5,5) = 1;
    CSimRParRRDualHandle(6,6) = 1;
    CSimRParRRDualHandle(7,6) = 1;
    CSimRParRRDualHandle(7,9) = 1;
    CSimRParRRDualHandle(8,6) = 1;
    CSimRParRRDualHandle(8,7) = -1;
    CSimRParRRDualHandle(9,9) = 1;

    CSimRParRRDualHandle(10,10) = 1;
    CSimRParRRDualHandle(11,11) = 1;
    ...
    SHiredisStructRParRRDualHandle redis_ds_;
        ...
        while(true == scl_chai_glut_interface::CChaiGlobals::getData()->chai_glut_running)
        {
          ...
          if(run_integrator){
            if(db->pause_ctrl_dyn_ == false)
            {
              ...
              // Apply constraints...
              rio.sensors_.q_ = CSimRParRRDualHandle * rio.sensors_.q_;
              rio.sensors_.dq_ = CSimRParRRDualHandle * rio.sensors_.dq_;
              rio.sensors_.ddq_ = CSimRParRRDualHandle * rio.sensors_.ddq_;
            ...
            redis_ds_.reply_ = (redisReply *)redisCommand(redis_ds_.context_, "SET %s %s","scl::RParRRDualHandle::q",rstr);
            freeReplyObject((void*)redis_ds_.reply_);
            ...
            redis_ds_.reply_ = (redisReply *)redisCommand(redis_ds_.context_, "SET %s %s","scl::RParRRDualHandle::dq",rstr);
            freeReplyObject((void*)redis_ds_.reply_);

          }
          else { //Run redis comm
            //Get desired pos from Redis database..
            redis_ds_.reply_ = (redisReply *)redisCommand(redis_ds_.context_, "GET scl::RParRRDualHandle::q");
            ...
            redis_ds_.reply_ = (redisReply *)redisCommand(redis_ds_.context_, "GET scl::RParRRDualHandle::dq");
            ...
            rio.sensors_.q_ = CRParRRDualHandle * q_robot;
            rio.sensors_.dq_ = CRParRRDualHandle * dq_robot;
          }
          ...
          redis_ds_.reply_ = (redisReply *)redisCommand(redis_ds_.context_, "SET %s %s","scl::RParRRDualHandle::fgc_commanded",rstr);
          freeReplyObject((void*)redis_ds_.reply_);

          sprintf(rstr,"%lf %lf %lf", rtask_lhand->x_(0),rtask_lhand->x_(1), rtask_lhand->x_(2));
          redis_ds_.reply_ = (redisReply *)redisCommand(redis_ds_.context_, "SET %s %s","scl::RParRRDualHandle::x_l",rstr);
          freeReplyObject((void*)redis_ds_.reply_);

          sprintf(rstr,"%lf %lf %lf", rtask_rhand->x_(0),rtask_rhand->x_(1), rtask_rhand->x_(2));
          redis_ds_.reply_ = (redisReply *)redisCommand(redis_ds_.context_, "SET %s %s","scl::RParRRDualHandle::x_r",rstr);
          freeReplyObject((void*)redis_ds_.reply_);
