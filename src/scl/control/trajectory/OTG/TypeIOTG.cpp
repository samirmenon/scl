...
TypeIOTG::TypeIOTG(const unsigned int &NoOfDOFs)
{
	this->CycleTime									=	0.001; //Default cycle time
...
//************************************************************************************
// Sets cycle time
void  TypeIOTG::SetCycleTimeInSeconds        (const double        &CycleTimeInSeconds  )
