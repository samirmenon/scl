...
#define SCL_COPPTTASK_TASK_DOF 3
  ...
  STaskOpPosNoGravity::STaskOpPosNoGravity() : STaskBase(),
      link_name_(""),
      link_ds_(S_NULL),
  ...
  STaskOpPosNoGravity::~STaskOpPosNoGravity()
  { }


  bool STaskOpPosNoGravity::initTaskParams()
  {
    try
    {
    ...
    {
      std::cerr<<"\nSTaskOpPosNoGravity::init() : "<<e.what();
      return false;
    }
    return true;
  }
