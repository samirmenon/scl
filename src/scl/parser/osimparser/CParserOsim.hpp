...
#ifndef CPARSEROSIM_HPP_
#define CPARSEROSIM_HPP_
...
namespace scl_parser
{
  ...
  class CParserOsim: public CParserBase
  {
  public:
    ...
    CParserOsim() : root_link_name_("ground") {}
    virtual ~CParserOsim() {}
