 ...
 ****************************************************************************/
  ...
  int         __SDK dhdGetAngularVelocityRad             (double *vx, double *vy, double *vz, char ID = -1);
  int         __SDK dhdGetAngularVelocityDeg             (double *vx, double *vy, double *vz, char ID = -1);
  ...
  int         __SDK dhdGetGripperAngularVelocityDeg      (double *wh, char ID = -1);
